...
public class ioo {
    ...
    public static PlayerManager playerManager
    {
        get
        {
            if (_playerManager == null)
                _playerManager = manager.GetComponent<PlayerManager>();
    ...
    public static CameraManager cameraManager
    {
        get
        {
            if (_cameraManager == null)
                _cameraManager = manager.GetComponent<CameraManager>();
    ...
    /// IO通信管理
    /// </summary>
    private static IOManager _ioManager = null;
    public static IOManager ioManager
    {
        get
        {
            if (_ioManager == null)
                _ioManager = manager.GetComponent<IOManager>();
            return _ioManager;
        }
    }
