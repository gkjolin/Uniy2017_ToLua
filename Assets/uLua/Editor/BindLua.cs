...
public static class LuaBinding
{
    ...
    [MenuItem("Lua相关/4 Gen Lua Wrap Files", false, 11)]
    ...
    static void GenLuaBinder()
    {
        ...
        string file = Const.LuaBasePath + "Base/LuaBinder.cs";
    ...
    [MenuItem("Lua相关/5 Clear LuaBinder File + Wrap Files", false, 13)]
    ...
    [MenuItem("Lua相关/1 Gen Lua Delegates", false, 2)]
    ...
    [MenuItem("Lua相关/2 Build Lua without jit", false, 4)]
    ...
    [MenuItem("Lua相关/3 Gen u3d Wrap Files(慎用)", false, 10)]
