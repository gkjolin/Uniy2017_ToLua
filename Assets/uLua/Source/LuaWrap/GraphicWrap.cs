...
public class GraphicWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("New", _CreateGraphic),
	...
	static int _CreateGraphic(IntPtr L)
	{
		LuaDLL.luaL_error(L, "Graphic class does not have a constructor function");
		return 0;
	}

	static Type classType = typeof(Graphic);
	...
	{
		LuaScriptMgr.Push(L, Graphic.defaultGraphicMaterial);
		return 1;
	}
	...
	static int get_raycastTarget(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, obj.raycastTarget);
		return 1;
	}
	...
	static int CrossFadeColor(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: Graphic.CrossFadeColor");
		}
