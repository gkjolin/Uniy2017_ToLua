...
public class ImageWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("New", _CreateImage),
	...
	{
		LuaScriptMgr.Push(L, Image.defaultETC1GraphicMaterial);
		return 1;
	}
	...
	static int set_type(IntPtr L)
	{
		...
		obj.type = (Image.Type)LuaScriptMgr.GetNetObject(L, 3, typeof(Image.Type));
		return 0;
	}
	...
	static int set_fillMethod(IntPtr L)
	{
		...
		obj.fillMethod = (Image.FillMethod)LuaScriptMgr.GetNetObject(L, 3, typeof(Image.FillMethod));
		return 0;
	}
	...
	static int OnBeforeSerialize(IntPtr L)
	{
		...
		Image obj = (Image)LuaScriptMgr.GetUnityObjectSelf(L, 1, "Image");
